...
# dialogue when interacting with skeleton
with open(r"/Users/ashleylim/PycharmProjects/NEA project/dialogue_text.txt", 'r') as fp:
    # lines to read
    line_numbers = [32, 33, 34]
    # To store lines
    skeleton_dialogue = []
    for i, line in enumerate(fp):
        if i in line_numbers:
            skeleton_dialogue.append(line.strip())
...
# the skeleton (enemy) before leading to the turn_based.py file.
    ...
    def thing(self):
        ...
        if self.char_type == "player":
            if self.rect.right > GWIDTH - RIGHT_THRESH:
                ...
                speed = 3
                active_message = 0
                message = skeleton_dialogue[active_message]
...
slime = Characters("skeleton", 795, 175, 3, 5)

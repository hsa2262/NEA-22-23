...
# dialogue when interacting with slime
with open(r"/Users/ashleylim/PycharmProjects/NEA project/dialogue_text.txt", 'r') as fp:
    ...
    for i, line in enumerate(fp):
        if i in line_numbers:
            slime_dialogue.append(line.strip())
...
# the slime (enemy) before leading to the turn_based.py file.
    ...
    def thing(self):
        ...
        if self.char_type == "player":
            if self.rect.right > GWIDTH - RIGHT_THRESH:
                ...
                speed = 3
                active_message = 0
                message = slime_dialogue[active_message]
...
slime = Characters("slime", 795, 207, 2, 5)

...
# dialogue after defeating final boss
with open(r"/Users/ashleylim/PycharmProjects/NEA project/dialogue_text.txt", 'r') as fp:
    # lines to read
    line_numbers = [49, 50, 51]
    # To store lines
    final_boss_dialogue = []
    for i, line in enumerate(fp):
        if i in line_numbers:
            final_boss_dialogue.append(line.strip())
...
enemy = Character("bringer-of-death", 600, 78, 4, 30, 11, 1)
...
while running:
    ...
    draw_text(f"Bringer of Death HP: {enemy.hp}", font, (255, 255, 255), 560, PHEIGHT - bottom_panel + 230)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_e:
                ...
                speed = 3
                active_message = 0
                message = final_boss_dialogue[active_message]
                ...
                while run:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN and active_message < 2 or event.type == pygame.KEYDOWN and event.key == pygame.K_RETURN:
                            ...
                            if active_message == 2:
                                message = final_boss_dialogue[active_message]
                                import enemy_encounters.summon_witch

...
enemy = Character("Bandit", 650, 70, 4, 30, 7, 1)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_e:
                ...
                speed = 3
                active_message = 0
                message = defeat_dialogue[active_message]
                ...
                while run:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.MOUSEBUTTONDOWN and active_message < 2 or event.type == pygame.KEYDOWN and event.key == pygame.K_RETURN:
                            ...
                            if active_message == 2:
                                message = defeat_dialogue[active_message]
                                import enemy_encounters.enemy_encounter4
